...
export class MovieDb {
  ...
  constructor(access_token: string, baseUrl: string = 'https://api.themoviedb.org/3/') {
   ...
   */
  private getEndpoint(endpoint: string, params: any = {}): string {
  ...
  private normalizeParams(endpoint: string, params: string | number | RequestParams = {}): RequestParams {
    ...
    const newMatches: any = matches

    if (newMatches.length === 1) {
      return newMatches.reduce((obj: any, match: any) => {
  ...
  private getParams(endpoint: string, params: RequestParams = {}): RequestParams {
    ...
    const compiledParams: RequestParams = params
  ...
  configuration(axiosConfig?: AxiosRequestConfig): Promise<types.ConfigurationResponse> {
    return this.makeRequest(HttpMethod.Get, 'configuration', undefined, axiosConfig)
  }

  countries(axiosConfig?: AxiosRequestConfig): Promise<types.CountriesResponse> {
    return this.makeRequest(HttpMethod.Get, 'configuration/countries', undefined, axiosConfig)
  }

  jobs(axiosConfig?: AxiosRequestConfig): Promise<Array<types.Job>> {
    return this.makeRequest(HttpMethod.Get, 'configuration/jobs', undefined, axiosConfig)
  }

  languages(axiosConfig?: AxiosRequestConfig): Promise<Array<types.Language>> {
    return this.makeRequest(HttpMethod.Get, 'configuration/languages', undefined, axiosConfig)
  }

  primaryTranslations(axiosConfig?: AxiosRequestConfig): Promise<Array<string>> {
    return this.makeRequest(HttpMethod.Get, 'configuration/primary_translations', undefined, axiosConfig)
  }

  timezones(axiosConfig?: AxiosRequestConfig): Promise<Array<types.Timezone>> {
    return this.makeRequest(HttpMethod.Get, 'configuration/timezones', undefined, axiosConfig)
  }
  ...
  accountInfo(axiosConfig?: AxiosRequestConfig): Promise<types.AccountInfoResponse> {
    return this.makeRequest(HttpMethod.Get, 'account', undefined, axiosConfig)
  }
  ...
  movieCertifications(axiosConfig?: AxiosRequestConfig): Promise<types.CertificationsResponse> {
    return this.makeRequest(HttpMethod.Get, 'certification/movie/list', undefined, axiosConfig)
  }

  tvCertifications(axiosConfig?: AxiosRequestConfig): Promise<types.CertificationsResponse> {
    return this.makeRequest(HttpMethod.Get, 'certification/tv/list', undefined, axiosConfig)
  }
